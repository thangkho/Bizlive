...
public class ListAdapterSearch extends ArrayAdapter<Posts> {
    Activity context;
    int resource;
    ...
    public ListAdapterSearch(Activity context, int resource, ArrayList<Posts> objects, String tableName,
                        ...
                        popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                            ...
                            public boolean onMenuItemClick(MenuItem arg0) {
                                ...
                                if (arg0.getTitle().equals("Phát thanh")) {
                                    ((SearchActivity) context).PlayAudioContent(objects, position);
                                ...
                                if (arg0.getTitle().equals("Điểm tin")) {
                                    ((SearchActivity) context).PlayAudioDes(objects, position);
                                    imgHead.setImageResource(R.drawable.icon_headed);
                                    PlayerConstants.CHECK_HOME = false;
                                    notifyDataSetChanged();
                                    popupMenu.dismiss();
