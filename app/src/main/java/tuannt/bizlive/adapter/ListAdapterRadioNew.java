...
public class ListAdapterRadioNew extends ArrayAdapter<Posts> {
    Activity context;
    int resource;
    ...
    public ListAdapterRadioNew(Activity context, int resource, ArrayList<Posts> objects, String tableName,
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        if (isServiceRunning && position == PlayerConstants.SONG_NUMBER ) {
...
//                            ((ListNewActivity) context).PlayAudioDes(objects, position);
//                            imgHead.setImageResource(R.drawable.icon_headed);
//                            imgHead.setVisibility(View.GONE);
...
//                            ((ListNewActivity) context).PlayAudioContent(objects, position);
//                            imgHead.setImageResource(R.drawable.icon_headed);
//                            imgHead.setVisibility(View.GONE);
//                            notifyDataSetChanged();
//                            PlayerConstants.CHECK_HOME=false;
