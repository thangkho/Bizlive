...
public class ListAdapterCategory extends ArrayAdapter<Posts> {
    Activity context;
    int resource;
    ...
    public ListAdapterCategory(Activity context, int resource, ArrayList<Posts> objects, String tableName,
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        if(isServiceRunning&&position== PlayerConstants.SONG_NUMBER&&PlayerConstants.PAGE_NUMBER==3){
