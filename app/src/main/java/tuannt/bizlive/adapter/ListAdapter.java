...
import tuannt.bizlive.model.PostSeria;
...
import tuannt.bizlive.custom.CustomImageListView;
...
public class ListAdapter extends ArrayAdapter<Posts> {
    ...
    private PlayAudioStream playAudioStream;

    public ListAdapter(Activity context, int resource, ArrayList<Posts> objects, String tableName,
                       String strlink, String category, PlayAudioStream playAudioStream) {
        super(context, resource, objects);
        this.context = context;
        this.resource = resource;
        this.objects = objects;
        this.tableName = tableName;
        this.playAudioStream = playAudioStream;
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        if (isServiceRunning && position == PlayerConstants.SONG_NUMBER && PlayerConstants.PAGE_NUMBER == 0 && !PlayerConstants.CHECK_HOME) {
...
//                popupMenu.getMenuInflater().inflate(R.menu.item_player, popupMenu.getMenu());
...
//                            ((MainActivity) context).PlayAudioDes(objects, position);
//                            imgHead.setImageResource(R.drawable.icon_headed);
...
//                            ((MainActivity) context).PlayAudioContent(objects, position);
//                            imgHead.setImageResource(R.drawable.icon_headed);
//                            PlayerConstants.CHECK_HOME = false;
//                            notifyDataSetChanged();
//                            popupMenu.dismiss();
