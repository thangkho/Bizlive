...
import tuannt.bizlive.adapter.ListAdapterActivityCategory;
import tuannt.bizlive.adapter.ListAdapterRadioNew;
...
import tuannt.bizlive.mediasever.Controls;
...
public class ListNewActivity extends Activity implements SwipeRefreshLayout.OnRefreshListener, ListAdapter.PlayAudioStream {
    ...
    ArrayList<Posts> arrDataNew = new ArrayList<Posts>();
...
//    static ProgressBar progressBar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PlayerConstants.PAGE_NUMBER=5;
        context=ListNewActivity.this;
...
//        progressBar = (ProgressBar) findViewById(R.id.progressBar);
        ...
        //categoryAdapter = new ListAdapter(ListNewActivity.this, R.layout.custom_item_list, arrDataNew, TableName.CATEGORY_RELATED + position, "http://content.amobi.vn/api/bizlive/get-type-post?type="+category+"&page=", "Thể Loại/" + category);
        myAdapter.setListAdapterRadioNew(new ListAdapterRadioNew(ListNewActivity.this,
                R.layout.custom_item_list, arrDataNew, TableName.CATEGORY_RELATED, "", "Thể Loại/"));
        list.setAdapter(myAdapter.getListAdapterRadioNew());
    ...
    protected void onStart() {
        super.onStart();
        PlayerConstants.CHECK_LISTNEW = true;
    }

    @Override
    protected void onStop() {
        super.onStop();
        PlayerConstants.CHECK_LISTNEW = false;
    }
    ...
    protected void onResume() {
        ...
        try {
            boolean isServiceRunning = UtilFunctions.isServiceRunning(SongService.class.getName(), ListNewActivity.this);
            if (isServiceRunning) {
                updateUI();
            } else {
...
//                    progressBar.setProgress(i[2]);
    ...
    public void onRefresh() {
        if (arrDataNew.size() > 0) {
            String id_postnew = arrDataNew.get(0).getPost_id().toString();
            ...
            new ReadJsonRfList(arrDataNew, TableName.CATEGORY_TABLE,
                    swipeRefreshLayout, ListNewActivity.this,
                    ListNewActivity.this, "ListNewActivity", myAdapter).execute(rf_gridhome);
        } else {
    ...
    public class RequestTask extends
        ...
        protected void onPostExecute(ArrayList<String> result) {// update screen
            ...
            if (result != null && result.size() > 0) {
                ...
                arrDataNew = GetData.getCategory(result.get(0));
                myAdapter.getListAdapterRadioNew().updateReceiptsList(arrDataNew);
//                String url = "http://content.amobi.vn/api/apiall?app_id=" + LinkData.APP_ID + "&type=detail-category&category_id=" + category_id + "&page=&limit=10&screen_size=" + MainActivity.height + "x" + MainActivity.width + "&last_id=";
                list.setOnScrollListener(new EndScrollHot(arrDataNew, ivBack, ListNewActivity.this, LinkData.NEW, 0,
                        false, TableName.MOSTREAD_TABLE, list, imgLoad, footer, ListNewActivity.this, "ListNewActivity"));
//                list.setScrollViewCallbacks(scrollListener);
    ...
    public void PlayAudioContent(ArrayList<Posts> objects, int position) {
        ...
        if (!isServiceRunning) {
            Intent i = new Intent(ListNewActivity.this, SongService.class);
            ListNewActivity.this.startService(i);
        } else {
    ...
    private void setListeners() {
        ...
        btnPlay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Controls.playControl(ListNewActivity.this);
            }
        });
        btnPause.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Controls.pauseControl(ListNewActivity.this);
            }
        });
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Controls.nextControl(ListNewActivity.this);
            }
        });
        btnPrevious.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Controls.previousControl(ListNewActivity.this);
            }
        });
        btnStop.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(ListNewActivity.this, SongService.class);
                ListNewActivity.this.stopService(i);
                rlPlayingSong.setVisibility(View.GONE);
...
//                    progressBar.setProgress(i[2]);
    ...
    public static void ShowProgess() {
        ...
        btnPause.setVisibility(View.GONE);
        btnPlay.setVisibility(View.GONE);
        myAdapter.getListAdapterRadioNew().notifyDataSetChanged();
    }
}
